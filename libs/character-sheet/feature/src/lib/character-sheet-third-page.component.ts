...
@Component({
  ...
  template: `
    ...
    <div cdkDropList>
      ...
      <!-- ── Magie paktu area ── -->
      <div class="cs-pact-magic-area">
        <!-- Row 1: Stupeň pozic -->
        <div class="cs-pact-row">
          <span class="cs-pact-row-label">Stupeň pozic</span>
          <input
        ...
        <!-- Row 2: Mystický taj -->
        <div class="cs-pact-row">
          <span class="cs-pact-row-label">Mystický taj</span>
          <input
      ...
      <!-- ── Profession rows grid ── -->
      <div class="cs-profession-grid">
        <span class="cs-prof-label">1. Povolání</span>
        <input
        ...
        <span class="cs-prof-label">2. Povolání</span>
        <input
