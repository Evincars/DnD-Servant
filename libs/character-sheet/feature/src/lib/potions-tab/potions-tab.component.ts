...
const POTIONS: Potion[] = [
  ...
  },
  {
    ...
    category: 'leceni',
    rarity: 'Neobvyklý',
    ingredients: ing(['Fénixí pero', 'Stříbrná kapradina (SO 15)', 'Roztavený jantar (minerál)'], 380, 'Lektvar vynikajícího léčení'),
    priceBuy: '500 zl',
    priceCraft: '380 zl',
    craftTime: '1 den',
    color: C.crimson,
  },
  {
    ...
    category: 'leceni',
    rarity: 'Vzácný',
    ingredients: ing(['Dračí žluč', 'Měsíční orchidej (SO 18, noc úplňku)', 'Prach z unicorn rohu'], 3800, 'Lektvar nejvyššího léčení'),
    priceBuy: '5 000 zl',
    priceCraft: '3 800 zl',
    craftTime: '3 dny',
    color: C.crimson,
  },
  {
    ...
    category: 'leceni',
    rarity: 'Běžný',
    ingredients: ing(['Bílý bez (bylina, okraje lesů)', 'Hadí svlak', 'Stříbřitá rosa (sbíraná za úsvitu)'], 75, 'Lektvar proti jedu'),
    priceBuy: '100 zl',
    priceCraft: '75 zl',
    craftTime: '3 hodiny',
    color: C.green,
  ...
  },
  {
    ...
    category: 'leceni',
    rarity: 'Vzácný',
    ingredients: ing(['Trollí srdce (čerstvé)', 'Salamandří olej', 'Diamantový prach (50 zl)'], 1500, 'Lektvar regenerace'),
    priceBuy: '2 000 zl',
    priceCraft: '1 500 zl',
    craftTime: '2 dny',
    color: C.pink,
  ...
  // ─── BOJ ──────────────────────────────────────────────
  {
    ...
    category: 'boj',
    rarity: 'Neobvyklý',
    ingredients: ing(['Obrova kost (prach)', 'Železný kořen (SO 14, hory)', 'Červené víno (staré, min. 10 let)'], 380, 'Lektvar síly obra'),
    priceBuy: '500 zl',
    priceCraft: '380 zl',
    craftTime: '1 den',
    color: C.brown,
  },
  {
    ...
    category: 'boj',
    rarity: 'Neobvyklý',
    ingredients: ing(['Kopcový kořen (SO 14)', 'Obrova svalovina', 'Zemní elementál prach (SO 13)'], 380, 'Lektvar síly kopcového obra'),
    priceBuy: '500 zl',
    priceCraft: '380 zl',
    craftTime: '1 den',
    color: C.brown,
  ...
  },
  {
    ...
    category: 'boj',
    rarity: 'Vzácný',
    ingredients: ing(['Gepardí pazneht', 'Blesková kapradina (SO 16, bouřka)', 'Rtuť (minerál, nebezpečná)'], 1500, 'Lektvar rychlosti'),
    priceBuy: '2 000 zl',
    priceCraft: '1 500 zl',
    craftTime: '2 dny',
    color: C.yellow,
  },
  {
    ...
    category: 'boj',
    rarity: 'Vzácný',
    ingredients: ing(['Oko mimika', 'Stínový mech (SO 15, tmavé jeskyně)', 'Destilovaný alkohol (90%+)'], 1500, 'Lektvar neviditelnosti'),
    priceBuy: '2 000 zl',
    priceCraft: '1 500 zl',
    craftTime: '2 dny',
    color: C.white,
  },
  {
    ...
    category: 'boj',
    rarity: 'Velmi vzácný',
    ingredients: ing(['Krev tarraska', 'Adamantinový prach (50 zl)', 'Srdce goléma'], 7500, 'Lektvar nezranitelnosti'),
    priceBuy: '10 000 zl',
    priceCraft: '7 500 zl',
    craftTime: '7 dní',
    color: C.silver,
  ...
  // ─── POHYB ────────────────────────────────────────────
  {
    ...
    category: 'pohyb',
    rarity: 'Běžný',
    ingredients: ing(['Pavučina (z velkého pavouka)', 'Gekoní lepidlo (žláza)', 'Kořen šplhavce (SO 12, skalní stěny)'], 55, 'Lektvar šplhání'),
    priceBuy: '75 zl',
    priceCraft: '55 zl',
    craftTime: '2 hodiny',
    color: C.teal,
  },
  {
    ...
    category: 'pohyb',
    rarity: 'Běžný',
    ingredients: ing(['Rybí žábry', 'Říční řasa (SO 11)', 'Perleťový prach (z ústřice)'], 55, 'Lektvar vodního dechu'),
    priceBuy: '75 zl',
    priceCraft: '55 zl',
    craftTime: '2 hodiny',
    color: C.blue,
  },
  {
    ...
    category: 'pohyb',
    rarity: 'Neobvyklý',
    ingredients: ing(['Peří gryfa', 'Vzdušný křemen (minerál, hory)', 'Destilát oblačnice (SO 15)'], 310, 'Lektvar levitace'),
    priceBuy: '400 zl',
    priceCraft: '310 zl',
    craftTime: '8 hodin',
    color: C.white,
  },
  {
    ...
    category: 'pohyb',
    rarity: 'Vzácný',
    ingredients: ing(['Pegasovo pero', 'Oblačný jantar (SO 17, bouřka)', 'Destilovaný vítr (magický proces)'], 2300, 'Lektvar létání'),
    priceBuy: '3 000 zl',
    priceCraft: '2 300 zl',
    craftTime: '2 dny',
    color: C.cyan,
  ...
  },
  {
    ...
    category: 'pohyb',
    rarity: 'Neobvyklý',
    ingredients: ing(['Gekoní tlapka', 'Lepivá pryskyřice (SO 13)', 'Alchymistická guma'], 270, 'Lektvar plazivosti'),
    priceBuy: '350 zl',
    priceCraft: '270 zl',
    craftTime: '6 hodin',
    color: C.green,
  ...
  // ─── MYSL ─────────────────────────────────────────────
  {
    ...
    category: 'mysl',
    rarity: 'Běžný',
    ingredients: ing(['Divoký med', 'Dryádina slza (dobrovolný dar)', 'Zvířecí srst (odpovídá druhu)'], 75, 'Lektvar přátelství zvířat'),
    priceBuy: '100 zl',
    priceCraft: '75 zl',
    craftTime: '3 hodiny',
    color: C.gold,
  },
  {
    ...
    category: 'mysl',
    rarity: 'Neobvyklý',
    ingredients: ing(['Jazyky slavíka (tři)', 'Růžová růže (sbíraná za rozbřesku)', 'Rubínový prach (minerál)'], 310, 'Lektvar charismatu'),
    priceBuy: '400 zl',
    priceCraft: '310 zl',
    craftTime: '8 hodin',
    color: C.pink,
  },
  {
    ...
    category: 'mysl',
    rarity: 'Vzácný',
    ingredients: ing(['Oko basilišky', 'Modrý lotosový květ (SO 16, noc)', 'Stříbrný prach (minerál)'], 1150, 'Lektvar jasnovidnosti'),
    priceBuy: '1 500 zl',
    priceCraft: '1 150 zl',
    craftTime: '2 dny',
    color: C.indigo,
  },
  {
    ...
    category: 'mysl',
    rarity: 'Vzácný',
    ingredients: ing(['Mozek mindflayera', 'Fialová iris (SO 15)', 'Destilát slz (magický proces)'], 1500, 'Lektvar čtení myšlenek'),
    priceBuy: '2 000 zl',
    priceCraft: '1 500 zl',
    craftTime: '2 dny',
    color: C.purple,
  },
  {
    ...
    category: 'mysl',
    rarity: 'Neobvyklý',
    ingredients: ing(['Mozek flumfa', 'Tyrkysový prach (minerál)', 'Ušní vosk obřího netopýra'], 310, 'Lektvar telepatie'),
    priceBuy: '400 zl',
    priceCraft: '310 zl',
    craftTime: '8 hodin',
    color: C.teal,
  ...
  // ─── JEDY ─────────────────────────────────────────────
  {
    ...
    category: 'jedy',
    rarity: 'Běžný',
    ingredients: ing(['Hadí jedový váček', 'Bolehlav (bylina, SO 11)', 'Žlučník obřího brouka'], 75, 'Základní jed'),
    priceBuy: '100 zl',
    priceCraft: '75 zl',
    craftTime: '2 hodiny',
    color: C.green,
  ...
  },
  {
    ...
    category: 'jedy',
    rarity: 'Vzácný',
    ingredients: ing(['Wyverní žihadlo (čerstvé)', 'Kyselina z ankhega (SO 14)', 'Tmavá melasa (konzervant)'], 920, 'Jed wyverna'),
    priceBuy: '1 200 zl',
    priceCraft: '920 zl',
    craftTime: '2 dny',
    color: C.green,
  ...
  },
  {
    ...
    category: 'jedy',
    rarity: 'Neobvyklý',
    ingredients: ing(['Carrion crawler sliz', 'Ghúlí dráp', 'Nervový extrakt z fázového pavouka'], 380, 'Jed paralýzy'),
    priceBuy: '500 zl',
    priceCraft: '380 zl',
    craftTime: '8 hodin',
    color: C.teal,
  },
  {
    ...
    category: 'jedy',
    rarity: 'Běžný',
    ingredients: ing(['Belladonna (bylina, SO 12)', 'Kryší žluč', 'Essence z nightshade (SO 13)'], 115, 'Assassin Blood'),
    priceBuy: '150 zl',
    priceCraft: '115 zl',
    craftTime: '3 hodiny',
    color: C.crimson,
  ...
  // ─── OSTATNÍ ──────────────────────────────────────────
  {
    ...
    category: 'ostatni',
    rarity: 'Neobvyklý',
    ingredients: ing(['Prach z víly (dobrovolný dar)', 'Mravenčí kyselina', 'Pixieho křídlový prach'], 230, 'Lektvar zmenšení'),
    priceBuy: '300 zl',
    priceCraft: '230 zl',
    craftTime: '6 hodin',
    color: C.violet,
  ...
  },
  {
    ...
    category: 'ostatni',
    rarity: 'Běžný',
    ingredients: ing(['Chameleoní kůže', 'Rtuťový květ (SO 12)', 'Popel z černého dřeva'], 115, 'Lektvar iluzorního vzhledu'),
    priceBuy: '150 zl',
    priceCraft: '115 zl',
    craftTime: '3 hodiny',
    color: C.silver,
  },
  {
    ...
    category: 'ostatni',
    rarity: 'Neobvyklý',
    ingredients: ing(['Ženšenový kořen (SO 13, vzácný)', 'Srdce vrány', 'Zlatý prach (minerál, 10 zl)'], 380, 'Lektvar vitality'),
    priceBuy: '500 zl',
    priceCraft: '380 zl',
    craftTime: '1 den',
    color: C.gold,
  },
  {
    ...
    category: 'ostatni',
    rarity: 'Běžný',
    ingredients: ing(['Vzdušná houba (SO 12, jeskyně)', 'Medúzí extrakt', 'Vzdušný elementál prach (SO 12)'], 75, 'Lektvar dlouhého dechu'),
    priceBuy: '100 zl',
    priceCraft: '75 zl',
    craftTime: '2 hodiny',
    color: C.cyan,
  ...
  },
  {
    ...
    category: 'ostatni',
    rarity: 'Neobvyklý',
    ingredients: ing(['Salamandří šupina', 'Červený korál (minerál)', 'Popel z ohnivého elementála'], 310, 'Lektvar odolnosti ohni'),
    priceBuy: '400 zl',
    priceCraft: '310 zl',
    craftTime: '8 hodin',
    color: C.orange,
  },
  {
    ...
    category: 'ostatni',
    rarity: 'Neobvyklý',
    ingredients: ing(['Ledový mech (SO 14, arktické jeskyně)', 'Yetí srst', 'Mentolový krystal'], 310, 'Lektvar odolnosti chladu'),
    priceBuy: '400 zl',
    priceCraft: '310 zl',
    craftTime: '8 hodin',
    color: C.cyan,
