...
@Component({
  ...
  styles: `
    ...
    .dlg-title mat-icon { font-size: 22px; width: 22px; height: 22px; color: #c8a03c; }
    ...
    :host ::ng-deep .dlg-body {
      ...
      h1 { font-size: 1.4em; border-bottom: 1px solid rgba(200,160,60,.3); padding-bottom: .3em; }
      h2, h3, h4 { font-size: 1.1em; }
      em { color: rgba(200,160,60,.8); font-style: italic; }
      strong { color: #d4c9a0; font-weight: bold; }
      p { margin: .5em 0; line-height: 1.55; font-size: 14px; }
      ul, ol { padding-left: 1.4em; margin: .4em 0; }
      li { margin: .2em 0; font-size: 14px; }
      table { border-collapse: collapse; width: 100%; margin: .8em 0; }
      th, td { border: 1px solid rgba(200,160,60,.25); padding: 5px 10px; font-size: 13px; }
      th { background: rgba(200,160,60,.1); color: #e8c96a; }
...
export class SpellDetailDialogComponent {
  ...
  private readonly _rawContent = toSignal(
    (() => {
      const spell = this.spellsService.findSpellByName(this.data.spellName);
      if (!spell) {
        return of(
          `<p>Kouzlo "<strong>${this.data.spellName}</strong>" nebylo nalezeno v databázi JaD.</p>`,
        );
      }
