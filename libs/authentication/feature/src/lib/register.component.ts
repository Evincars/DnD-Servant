    ...
    <div class="auth-page">
      <div class="auth-card">
        ...
        <div class="auth-social">
          <button class="auth-btn-google" type="button" (click)="onGoogleRegister()">
...
export class RegisterComponent {
  ...
  onSubmit(): void {
    ...
    this.authService
      ...
      .subscribe({
        next: () => {
          this.snackBar.open('⚔️ Registrace úspěšná! Vítej v kronice, hrdino.', '✕', {
  ...
  onGoogleRegister(): void {
    this.authService
      ...
      .subscribe({
        next: () => {
          this.snackBar.open('⚔️ Registrace přes Google úspěšná! Vítej v kronice, hrdino.', '✕', {
            verticalPosition: 'top',
            duration: 3500,
            panelClass: ['snackbar--success'],
          });
